...
export function SendGiftModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center safe-modal-overlay bg-black/85 backdrop-blur-xl animate-fadeIn select-none overflow-hidden box-border">
      <div className="w-full max-w-lg rounded-2xl sm:rounded-3xl p-3.5 sm:p-5 md:p-6 shadow-2xl border border-rose-500/40 bg-gradient-to-b from-slate-900/95 via-background-darker/95 to-slate-950/95 flex flex-col h-full max-h-[100%] overflow-hidden relative backdrop-blur-2xl min-w-0 box-border">
        {/* Glows Decorativos */}
