                        ...
                        <div className="mt-4 pt-3 border-t border-slate-800/80 flex items-center gap-2">
                          {isEquipped ? (
                            <button
                              ...
                              className="w-full py-2 rounded-xl bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 text-xs font-extrabold flex items-center justify-center gap-1.5 hover:bg-emerald-500/30"
                            >
                              <Check className="w-3.5 h-3.5" /> Equipado (Desequipar)
                            </button>
                          ) : (
                            <button
                              onClick={() => handleEquipItem(item)}
                              className="w-full py-2 rounded-xl bg-amber-500/20 text-amber-300 hover:bg-amber-500/30 border border-amber-500/40 text-xs font-extrabold flex items-center justify-center gap-1.5 transition-all"
                            >
                              <Sparkles className="w-3.5 h-3.5" /> Equipar Agora
                            </button>
                          )}
                        </div>
                      </div>
                    ...
                    <div className="mt-4 pt-3 border-t border-slate-800/80">
                      {isEquipped ? (
                        ...
                        <button
                          ...
                          className={`w-full py-2 rounded-xl text-xs font-extrabold flex items-center justify-center gap-1.5 shadow-md transition-all ${
                            canAfford
