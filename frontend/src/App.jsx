...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="fixed inset-0 h-full w-full flex flex-col items-center justify-center bg-slate-950 text-white p-6 text-center select-none z-50">
          <img src="/logo.gif" alt="Nexus Logo" className="w-20 h-20 object-contain mb-4 drop-shadow-[0_0_20px_rgba(99,102,241,0.6)]" />
          <h2 className="text-xl font-bold text-slate-100 mb-2">Ops! Algo inesperado aconteceu.</h2>
          <p className="text-xs text-slate-400 max-w-md mb-6">
            Ocorreu uma pequena instabilidade temporária ao carregar a interface.
          </p>
          <button
            onClick={() => {
            ...
            className="px-5 py-2.5 rounded-xl bg-brand-600 hover:bg-brand-500 text-white font-bold text-xs shadow-lg shadow-brand-600/30 transition-all cursor-pointer"
          >
